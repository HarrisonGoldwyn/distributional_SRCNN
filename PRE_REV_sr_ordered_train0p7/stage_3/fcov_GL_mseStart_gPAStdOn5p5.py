...
#     pass
try:
    fit_params = np.load(f"/projects/ecrpstats/distributional_SRCNN/stage_2/parCov_fitting_fourier_allImages_mseStart_globalPrior_anal_empPriorStdOn{scale_factor_str}_param_fits.npy")
except:
    pass
