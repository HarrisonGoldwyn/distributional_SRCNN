...
#     pass
try:
    test_mse_error_fields = np.load("/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p75/stage_1/mse_5l_i123_c32s_padR_schLrG0p95_reg0_errFields.npy")
    train_mse_error_fields = np.load("/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p75/stage_1/mse_5l_i123_c32s_padR_schLrG0p95_reg0_TrainErrFields.npy")
except:
    pass
...
try:
    global_fit_params = np.load("/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p75/stage_2/anal_sln_global_params.npy")
except:
    pass
...
global_fit_param_stdd = np.load("/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p75/stage_2/img_spec_params_std.npy")
...
def gaussian_loss_basis_cov(
    ...
    ## Define global prior
    prior = (global_fit_params - torch.exp(log_parmas))**2 / (global_fit_param_stdd / 1.5)**2
