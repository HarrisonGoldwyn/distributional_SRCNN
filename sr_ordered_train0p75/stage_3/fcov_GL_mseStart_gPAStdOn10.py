...
#     pass
try:
    fit_params = np.load("/projects/ecrpstats/distributional_SRCNN/sr_ordered_train0p75/stage_2/parCov_fitting_fourier_allImages_mseStart_globalPrior_anal_empPriorStdOn10_param_fits.npy")
except:
    pass
...
if train_or_load == 'train':
    ...
    desired_file = "/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p75/stage_1/mse_5l_i123_c32s_padR_schLrG0p95_reg0/2025-05-21_t134912/499_l6.948e+01.pt"
