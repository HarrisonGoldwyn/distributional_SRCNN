...
#     pass
try:
    fit_params = np.load("/projects/ecrpstats/distributional_SRCNN/stage_2/parCov_fitting_fourier_allImages_mseStart_globalPrior_anal_empPriorStdOn1_param_fits.npy")
except:
    pass
