...
#     pass
try:
    fit_params = np.load("/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p7/stage_2/parCov_fitting_fourier_allImages_mseStart_globalPrior_anal_empPriorStdOn10_param_fits.npy")
except:
    pass
