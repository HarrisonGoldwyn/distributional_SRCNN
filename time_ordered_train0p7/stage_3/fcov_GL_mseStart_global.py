...
# try:
#     fit_params = np.load("/Users/hgoldwyn/Research/projects/SR_CNN/sr_cnn/real_data/torch/scripts/interp_upscale/HR_64x64/fourier_proj_cov/global_params/cov_param_fits_global_mseStart.npy")
# except:
#     pass
# try:
#     fit_params = np.load("/projects/ecrpstats/sr_cnn/real_data/torch/scripts/interp_upscale/HR_64x64/fourier_proj_cov/global_params/cov_param_fits_global_mseStart.npy")
# except:
#     pass
