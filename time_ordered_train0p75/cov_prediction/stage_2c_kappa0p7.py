...
#     pass
try:
    test_mse_error_fields = np.load("/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p75/stage_1/output_data/mse_5l_i123_c32s_padR_schLrG0p95_reg0_errFields.npy")
    # train_mse_error_fields = np.load("/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p75/stage_1/output_data/mse_5l_i123_c32s_padR_schLrG0p95_reg0_TrainErrFields.npy")
except:
    pass
...
mse_error_fields = test_mse_error_fields
...
try:
    global_fit_params = np.load("/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p75/stage_2/output_2a/anal_sln_global_params.npy")
except:
    pass
...
global_fit_param_stdd = np.load("/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p75/stage_2/output_2a/img_spec_params_std.npy")
