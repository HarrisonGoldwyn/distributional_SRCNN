...
## Load covariance parameters and basis functions
# try:
#     fit_params = np.load("/Users/hgoldwyn/Research/projects/SR_CNN/sr_cnn/real_data/torch/scripts/parCov_fitting/mse/from_kestrel/cov_param_fits_noJprior.npy")
# except:
#     pass
try:
    fit_params = np.load("/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p75/stage_2/parCov_fitting_fourier_allImages_mseStart_globalPrior_anal_empPriorStdOn10_param_fits.npy")
except:
    pass
...
def _gaussian_loss_emp_cov(y_pred, y_data, labels):
    result = gaussian_loss_emp_cov(
        y_pred, y_data, labels,
        pixel_count=hr_data_size**2
        )
    return result
...
if train_or_load == 'train':
    ...
    desired_file = "/projects/ecrpstats/distributional_SRCNN/time_ordered_train0p75/stage_1/mse_5l_i123_c32s_padR_schLrG0p95_reg0/2025-05-13_t161143/499_l4.002e+03.pt"
